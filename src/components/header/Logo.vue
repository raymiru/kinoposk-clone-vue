        ...
        methods: {
            ...
            dropdownMobile() {
                if (this.breakpoint === 'mobile') {
                    !this.mobileDropdownActive ? this.$store.commit('changeMobileDropdownActiveState', true) :
